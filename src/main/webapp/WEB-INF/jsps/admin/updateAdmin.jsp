...
<body>
	...
	<div class="formbody">
	   <div id="usual1" class="usual"> 
		    <div class="itab">
			  	<ul> 
			   		<li><a class="selected">添加管理员</a></li> 
			  	</ul>
		    </div> 
		  	<div id="tab1" class="tabson">
		    	<div class="formtext">您好，欢迎您使用管理员添加功能！<b>请勿更改</b></div>
		    	<div class="forminfo">
		    	<table>
		    		<tr>
		    		...
		    		<tr>
		    			...
		    			<td>
		    				<form:input path="username" cssClass="dfinput" cssStyle="float:left;"/>
		    				&nbsp;<form:errors path="username" cssStyle="padding-left:10px;color:red;"/>
		    			</td>
		    		</tr>
		    		<tr style="height:10px;">
		    		</tr>
		    		<tr style="margin-top:10px;">
		    			...
		    			<td>
		    				...
		    				<form:radiobutton path="state" value="0" cssClass="dfrad"/>管理员
				    		<form:radiobutton path="state" value="1" cssClass="dfrad"/>系统管理员
		    				</div>
