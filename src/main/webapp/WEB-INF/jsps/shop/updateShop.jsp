		    ...
		    <div class="itab">
		  	...
		  	<div id="tab1" class="tabson">
		    	...
		    	<table>
		    		...
		    		<tr id="thumbImage">
		    			<td class='tableleft'>商铺缩略图</td>
						<td>
							<div id='thumbImage'>
								<input type="hidden" name="url" value="${shopDto.url}"/>
								<img src="${pageContext.request.contextPath}/resources/upload/shop/thumbnail/${shopDto.url}">;
							</div>
						</td>
		    		</tr>
		    		<tr style="height:10px;">
		    		...
		    		<tr>
		    			...
		    			<td><form:textarea path="description" id="myEditor" type="text/plain" cssStyle="width:620px;height:200px;"/></td>
		    		</tr>
		    		<tr style="height:10px;">
		    		</tr>
		    		<tr>
